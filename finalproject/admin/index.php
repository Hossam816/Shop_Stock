...
<head>
    ...
    <title>ECO MMERCE | Dashboard</title>
    <meta name="description" content="Ela Admin - HTML5 Admin Template">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="apple-touch-icon" href="../images/ALogo.png">
    <link rel="shortcut icon" href="../images/ALogo.png">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="menu-item-has-children dropdown">
              <a
                ...
                aria-expanded="false"
              >
                <i class="menu-icon fa fa-th"></i>Departments</a
              >
              <ul class="sub-menu children dropdown-menu">
                <li>
                  <i class="menu-icon fa fa-th"></i
...
<footer class="site-footer" style="width: 90%; text-align:center">
